...
namespace OpenTK_winforms_z02
{
    public partial class Form1 : Form
    {
        ...
        private void SetupWindowGUI() {
            ...
            setTrackLight1IntensityDefault();
        ...
        private void setTrackLight1IntensityDefault()
        {
            trackLight1Intensity.Value = (int)light1.Diffuse[0] * 100; ;
            GlControl1.Invalidate();
        }

        private void trackLight1Intensity_Scroll(object sender, EventArgs e)
        {
            float intensity = (float)trackLight1Intensity.Value / 100f;

            // Setăm Diffuse la aceeași intensitate
